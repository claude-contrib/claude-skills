...
* add nix flake for reproducible dev environment ([a9a872a](https://github.com/claude-contrib/claude-skills/commit/a9a872ae1e64698c0eb67e4ec4ebeb7749fca03a))
...
* initial scaffold for claude-skills marketplace ([b98a0d9](https://github.com/claude-contrib/claude-skills/commit/b98a0d922e8673d9e7fbd9da73c86b8512dac466))
